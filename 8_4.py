...
def draw_mario_walk():
    global screen,mario_walk_count,mario_is_big,diff_screen
    if mario_walk_count == 0:
        if mario_face_turn == 0:
            if mario_is_big == False:
                screen.blit(mario,(mario_x -diff_screen,mario_y),mario_rect_walk1_left)
            else:
                screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_walk1_left_big)
        else:
            if mario_is_big == False:
                screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_walk1_right)
            else:
                screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_walk1_right_big)
    elif mario_walk_count == 1:
        if mario_face_turn == 0:
            if mario_is_big == False:
                screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_walk2_left)
            else:
                screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_walk2_left_big)
        else:
            if mario_is_big == False:
                screen.blit(mario,(mario_x - diff_screen ,mario_y),mario_rect_walk2_right)
            else:
                screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_walk2_right_big)
    mario_walk_count += 1
    if mario_walk_count == 2:
        mario_walk_count = 0

def draw_turtle_walk():
    global screen,turtle_sprite_count,diff_screen
    if turtle_sprite_count == 0:
        if turtle_face_turn == 0:
            screen.blit(turtle,(turtle_x - diff_screen,turtle_y),turtle_rect_walk1_left)
        else:
            screen.blit(turtle,(turtle_x - diff_screen,turtle_y),turtle_rect_walk1_right)
    elif turtle_sprite_count == 1:
        if turtle_face_turn == 0:
            screen.blit(turtle,(turtle_x - diff_screen,turtle_y),turtle_rect_walk2_left)
        else:
            screen.blit(turtle,(turtle_x - diff_screen,turtle_y),turtle_rect_walk2_right)
...
def draw_turtle_die():
    global screen,diff_screen
    screen.blit(turtle,(turtle_x - diff_screen,turtle_y + 7),turtle_die_rect)

def turtle_walk():
    global turtle_walk_count,turtle_x,turtle_face_turn,mario_x,diff_screen
...
def check_collide():
    global points,mario_alive,turtle_alive,mario_face_turn,turtle_x,turtle_y,mario_x,mario_y,mario_is_fall
    ...
    if mario_is_big == True:
        ...
        mario = pygame.Rect(mario_x,mario_y,17,29)
    #print(mario)
    for i in range(len(coin_pos)):
        if coin_pos[i] == -1:
            continue
...
def draw_mario_die():
    ...
    screen.blit(mario,(mario_x - diff_screen ,mario_y - 15),mario_die_rect)
...
def draw_mario_jump():
    global screen,mario_face_turn,mario_is_big,mario_x,screen_x,mario_vel_x,diff_screen

    if mario_face_turn == 0:
        if mario_x - screen_x < 400:  # or  mario_x < (screen_x + 400) / 2 :
            screen_x -= mario_vel_x
            diff_screen -= mario_vel_x
        if mario_is_big == False:
            screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_left_jump)
        else:
            screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_left_jump_big)
    else:
        if mario_x - screen_x > 400:
            screen_x += mario_vel_x
            diff_screen += mario_vel_x
        if mario_is_big == False:
            screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_right_jump)
        else:
            screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_right_jump_big)
...
def draw_mushroom():
    ...
    screen.blit(mario,(mushroom_x - diff_screen,mushroom_y),mushroom_rect)
...
def mario_jump():
    global mario_x,mario_y,mario_face_turn,mario_vel_x,jump_step,mario_is_jump,is_play_jump_sound,mario_is_fall,mario_is_big
    ...
    jump_step += 1
    if jump_step >= max_point * 2:
        jump_step = 0
        mario_is_jump = False
        is_play_jump_sound = False
        #mario_is_fall = False

    #print(" MARIO is fall " , mario_is_fall)
...
while not done:   #game loop  (ให้ใช้เวลาน้อยสุด)
    ...
    if mario_alive == True:
        if mario_is_jump == True:
            ...
            if mario_face_turn == 0:
                if mario_is_big == False:
                    screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_left)
                else:
                    screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_left_big)
            else:
                if mario_is_big == False:
                    screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_right)
                else:
                    screen.blit(mario,(mario_x - diff_screen,mario_y),mario_rect_right_big)
    ...
    text2 = myfont.render("Dev by S Teacher", True, (255, 255, 0))
